...
---@field variant? "back" | "dialog"
---@field childs? invaderWidgetChildWidget[]

---Generic table button for table usage
---@param props buttonMultiProps
---@return string
return function(props)
    local name = props.name
    local text = props.text
    local variant = props.variant or "back"
    ...
    local size = {width = 110, height = 30, scale = 0.5}
    ...
    local wid = {
        ...
        background_bitmap = [[keymind/helljumper/ui/bitmaps/back_button.bitmap]],
